    ...
    <div className="accueil-container">
      ...
      <div className="accueil-container2">
        ...
        <div className="actualite-box">
          <Actualite
            image={import('../img/DivinaComedia.jpg')} alt="Description de l'image"
        ...
        <div className="actualite-box">
          <Actualite
            image={import('../img/zerocalcare.jpg')} alt="Description de l'image"
        ...
        <div className="actualite-box">
          <Actualite
            image={import('../img/greenPea.jpg')} alt="Description de l'image"
        ...
        <div className="actualite-box">
          <Actualite
            image={import('../img/sergio.jpg')} alt="Description de l'image"
        ...
        <div className="actualite-box">
          <Actualite
            image={import('../img/dal.jpg')} alt="Description de l'image"
        ...
        <div className="actualite-box">
          <Actualite
            image={import('../img/raffaelloSuperstar.jpg')} alt="Description de l'image"
        ...
        <div className="actualite-box">
          <Actualite
            image={import('../img/lupi.jpg')} alt="Description de l'image"
        ...
        <div className="actualite-box">
          <Actualite
            image={import('../img/portata.jpg')} alt="Description de l'image"
